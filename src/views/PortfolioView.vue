...
const projectLinks = [
  {
    id: 1,
    imageUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/common/MJDHNODO-1711590377666Pasted Graphic 1.png',
    tech: 'Vue，Tailwind',
    github: 'null',
    demo: 'http://mywebsite.ssdwgg.site/'
  },
  {
    id: 9,
    imageUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/common/PHFKHGNC-1711595226918WGG BLOG.png',
    tech: 'VitePress',
    github: 'https://github.com/SSDWGG/ssdwgg.github.io',
    demo: 'http://blog.ssdwgg.site/'
  },
  {
    id: 5,
    imageUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/common/EFANMBKF-1711591497556Pasted Graphic 6.png',
  ...
  {
    id: 8,
    imageUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/common/NAICMCGG-1711594579198Pasted Graphic 7.png',
    tech: 'Vue2Js, Springboot',
    github: 'https://github.com/SSDWGG/rabbitMall',
    demo: 'http://mall.ssdwgg.site'
  },
  {
    id: 2,
    imageUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/common/KDLHCKEC-1711590640895Pasted Graphic 2.png',
    tech: 'Html, Github',
...
export default {
  ...
  computed: {
    portfolioCopy() {
      return appCopy[this.languageState.locale].portfolio;
    },
    items() {
      return this.portfolioCopy.items.map((item, index) => ({
        ...projectLinks[index],
        ...item,
      }));
    },
                ...
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full flex justify-end">
                    <div class="flex cursor-pointer items-end gap-2 text-primary">
                      <a v-if="item.github !== 'null'" :href="item.github" target="_blank" rel="noreferrer" :title="portfolioCopy.sourceTitle"
                      ...
                      <a v-if="item.demo !== 'null'" :href="item.demo" target="_blank" rel="noreferrer" :title="portfolioCopy.demoTitle"
                        class="transition-all hover:text-accent">
                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
