...
import { EasePack } from 'gsap-trial/EasePack'
...
//         }),
//         gsap.timeline().to(a, {
//           duration: gsap.utils.random(.61, 6), physics2D: {
...
//         duration: 6,
//         motionPath: {
//           path: ".treePath", autoRotate: !1
//         }, ease: "linear"
//       }).to(".pContainer, .sparkle",
//         {
//         duration: 1, onStart: function () { e = !1 }, x: q[0].x, y: q[0].y
//         }).to(".pContainer, .sparkle", {
//           duration: 2,
...
//       drawSVG: "0% 0%", stroke: "#FFF", stagger: { each: 6 },
...
//       },
//         "+=1");
//     c.add(k, 0); gsap.globalTimeline.timeScale(1.5)
//   }
